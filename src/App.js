...
export default class App extends Component {
    ...
    radioClicked = (opt) => {
        ...
        this.setState({
            audioFile:
                './audio/' + this.state.currentOptions[clickedOpt] + '.mp3',
        });
    };
        ...
        return (
            <div style={containerStyle}>
                <div id="resultsPage" style={resultsStyle}>
                    <BigWord
                        word={
                            choseRight ? "You're Right!" : 'Whoops, try again!'
                        }
                        color={choseRight ? 'green' : 'red'}
                    />
                    <button onClick={this.restart} style={buttonStyle}>
                        {choseRight ? 'Play Again' : 'Try Again'}
                    </button>
                </div>
                <div style={wordStyle}>
                    <BigWord
                        word={this.state.currentOptions[this.state.whichOpt]}
                        color={colorsArray[this.state.currentColor]}
                    />
                </div>
                <div style={optionsStyle}>
                    ...
                    <br />
                    <button onClick={this.buttonClick} style={buttonStyle}>
                        Choose
                    </button>
                </div>
                <AudioPlayer
